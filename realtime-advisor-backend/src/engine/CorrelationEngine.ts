...
export class CorrelationEngine {
  private static matrix: Record<string, Record<string, number>> = {};

  public static setMatrix(newMatrix: Record<string, Record<string, number>>): void {
    this.matrix = newMatrix;
  }

  public static getCorrelation(sym1: string, sym2: string): number {
   ...
   */
  public static calculateReturns(candles: Candle[]): number[] {
