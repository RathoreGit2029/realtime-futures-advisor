...
class ExplainabilityAPI {
    ...
    explainRecentDecisions(symbol, timeWindowMs = 60000) {
        ...
        const currentState = currentStateEvent ? currentStateEvent.payload.to : Types_js_1.MarketState.NO_TRADE;
        return {
            symbol,
            currentState,
            tradeEligible: rejections.length === 0 && currentState === Types_js_1.MarketState.EXECUTION_WINDOW,
...
exports.ExplainabilityAPI = ExplainabilityAPI;
